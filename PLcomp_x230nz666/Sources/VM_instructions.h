...
struct CVMInst_Equal : CVirtualMachineInstruction { CVMInst_Equal(); };
struct CVMInst_NotEqual : CVirtualMachineInstruction { CVMInst_NotEqual(); };
struct CVMInst_Less : CVirtualMachineInstruction { CVMInst_Less(); };
struct CVMInst_LessEqual : CVirtualMachineInstruction { CVMInst_LessEqual(); };
struct CVMInst_Greater : CVirtualMachineInstruction { CVMInst_Greater(); };
struct CVMInst_GreaterEqual : CVirtualMachineInstruction { CVMInst_GreaterEqual(); };